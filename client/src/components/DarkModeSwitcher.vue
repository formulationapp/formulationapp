...
<template>
  <button v-if="dark" @click="switchDarkMode" class="flex items-center justify-center" aria-label="Toggle dark mode">
    <svg viewBox="0 0 15 15" width="1.2em" height="1.2em" class="w-5 h-5 text-foreground">
