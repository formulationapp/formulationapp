<template>
  <div class="border border-b p-4 rounded-md">
    ...
    <input :readonly="!props.readonly" :required="props.block.details.required" type="text" v-model="value" @change="setAnswer"
...
onMounted(() => {
  if (!props.readonly)
    value.value = 'User will enter answer here...';
});
</script>